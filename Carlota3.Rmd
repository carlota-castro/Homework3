...
select(salary,gender)%>%
  group_by(gender)%>%
  summarise(mean_sal=mean(salary),sd_sal=sd(salary),sample_size=n(),t_crit=qt(0.975,sample_size-1),se_sal=sd_sal/sqrt(sample_size),margin_error=t_crit*se_sal,low=mean_sal-margin_error,high=mean_sal+margin_error)
